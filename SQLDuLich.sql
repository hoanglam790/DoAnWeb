USE [master]
GO
/****** Object:  Database [QuangBaDL]    Script Date: 15/06/2022 11:59:35 PM ******/
CREATE DATABASE [QuangBaDL]
GO
USE [QuangBaDL]
GO
/****** Object:  Table [dbo].[DIADANH]    Script Date: 15/06/2022 11:59:35 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[HINHANH]    Script Date: 15/06/2022 11:59:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[HUYEN]    Script Date: 15/06/2022 11:59:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[KHACHSAN]    Script Date: 15/06/2022 11:59:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TAIKHOAN]    Script Date: 15/06/2022 11:59:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[THELOAITIN]    Script Date: 15/06/2022 11:59:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TINTUC]    Script Date: 15/06/2022 11:59:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TOURDULICH]    Script Date: 15/06/2022 11:59:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[HUYEN] ([MaHuyen], [TenHuyen], [MieuTa], [MaKS]) VALUES (1, N'Quận Hải Châu', N'Sau khi tách tỉnh Quảng Nam – Đà Nẵng thành tỉnh Quảng Nam và thành phố Đà Nẵng, Quận Hải Châu được thành lập vào ngày 23/01/1997 và trở thành quận trung tâm của thành phố Đà Nẵng.
...
Quận Hải Châu có diện tích 21,35 km2, chiếm 1,66% diện tích toàn thành phố; Dân số (năm 2010): 196.098 người, chiếm 21,17% số dân toàn thành phố; Mật độ dân số: 9.184,92 người/km2. (Theo niên giám thống kê thành phố Đà Nẵng năm 2010).
...
Với vị trí là một quận trung tâm, nằm sát trục giao thông Bắc Nam và cửa ngõ ra biển Đông, cùng một hệ thống hạ tầng giao thông phát triển mạnh, đồng thời là trung tâm hành chính, thương mại, dịch vụ của thành phố, tập trung đông dân cư và các cơ quan, văn phòng của hầu hết các doanh nghiệp trên địa bàn thành phố. Vì vậy, quận Hải Châu có một tầm quan trọng đặc biệt trong sự phát triển của thành phố Đà Nẵng, giữ vai trò là trung tâm chính trị-hành chính-kinh tế-văn hoá và là địa bàn trọng điểm về an ninh, quốc phòng của thành phố Đà Nẵng.', 3)
GO
INSERT [dbo].[HUYEN] ([MaHuyen], [TenHuyen], [MieuTa], [MaKS]) VALUES (2, N'Hòa Vang', N'Hòa Vang là một huyện ngoại thành thuộc thành phố Đà Nẵng, Việt Nam. Đây là huyện duy nhất của thành phố Đà Nẵng nằm trên phần đất liền của thành phố.', 6)
GO
INSERT [dbo].[HUYEN] ([MaHuyen], [TenHuyen], [MieuTa], [MaKS]) VALUES (3, N'Quận Cẩm Lệ', N'Cẩm Lệ là một quận nội thành thuộc thành phố Đà Nẵng, Việt Nam.', 2)
GO
INSERT [dbo].[HUYEN] ([MaHuyen], [TenHuyen], [MieuTa], [MaKS]) VALUES (4, N'Quận Ngũ Hành Sơn', N'Quận Ngũ Hành Sơn nằm về phía đông nam thành phố Đà Nẵng, có vị trí địa lý:
...
Quận có diện tích 37 km², dân số là 105.237 người và là quận ít dân nhất thành phố Đà Nẵng.', 5)
GO
INSERT [dbo].[HUYEN] ([MaHuyen], [TenHuyen], [MieuTa], [MaKS]) VALUES (5, N'Quận Sơn Trà', N'Sơn Trà là một quận nội thành thuộc thành phố Đà Nẵng, Việt Nam.

Trên địa bàn quận có bán đảo Sơn Trà và núi Sơn Trà với 4.400 ha được công nhận là khu vực bảo tồn thiên nhiên vào năm 1992.', 7)
GO
INSERT [dbo].[HUYEN] ([MaHuyen], [TenHuyen], [MieuTa], [MaKS]) VALUES (6, N'Quận Thanh Khê', N'Thanh Khê là một quận nội thành thuộc thành phố Đà Nẵng, Việt Nam.

Đây là địa phương có nhiều lợi thế trong phát triển thương mại, dịch vụ, giao thông vận tải và kinh tế biển với chiều dài bờ biển khoảng 4,287 km trải dài trên 4 phường giáp vịnh Đà Nẵng ở phía bắc là Thanh Khê Tây, Thanh Khê Đông, Xuân Hà, Tam Thuận, có điều kiện thuận lợi trong việc nuôi trồng, khai thác và chế biển hải sản.', 9)
GO
INSERT [dbo].[HUYEN] ([MaHuyen], [TenHuyen], [MieuTa], [MaKS]) VALUES (7, N'Quận Liên Chiểu', N'Liên Chiểu là một quận nội thành thuộc thành phố Đà Nẵng, Việt Nam.', 8)
GO
